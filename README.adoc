...
| 1    | link:src/main/java/iut/sae/algo/AlgoSimplicite.java[Meuilleur Java Simplicite]   | Java     | Simplicité
| 2    | link:src/main/java/iut/sae/algo/AlgoEfficacite.java[Meuilleur Java Efficacité]   | Java     | Efficacité
| 3    | link:src/main/java/iut/sae/algo/AlgoSobriete.java[Meuilleur Java Sobriété]     | Java     | Sobriété      
|==========================================================================
...
Pour exécuter les codes d'évaluation, vous devez avoir les éléments suivants installés sur votre machine :

* Java JDK version 11 ou supérieure
* JUnit version 5.7.1 ou supérieure
* Codacy pour la mesure de qualité de code
* Joular pour la mesure de la sobriété numérique

=== Reproductibilité


Pour reproduire nos analyses, suivez les étapes ci-dessous :

1. **Téléchargement des fichiers** :
   - Téléchargez les fichiers nécessaires depuis le dépôt initial qui vous a été attribué via classroom.

2. **Préparation des fichiers** :
   - Renommez les fichiers et les classes selon les conventions suivantes :
     * Pour un algorithme de simplicité : nommez le fichier `simplicite.java` et la classe `Simplicite`.
     * Pour un algorithme d'efficacité : nommez le fichier `efficacite.java` et la classe `Efficacite`.
     * Pour un algorithme de sobriété : nommez le fichier `sobriete.java` et la classe `Sobriete`.

3. **Installation des dépendances** :
   - Assurez-vous que Java et JUnit sont installés. Vous pouvez utiliser un gestionnaire de paquets comme Maven ou Gradle pour gérer les dépendances de JUnit.

4. **Exécution des tests JUnit** :
   - Exécutez les tests JUnit fournis pour vérifier que votre code respecte les spécifications. 
